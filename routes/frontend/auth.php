...
Route::group(['namespace' => 'Auth', 'as' => 'auth.'], function () {
    ...
    //     Route::get('login', [LoginController::class, 'showLoginForm'])->name('loginAuth');
    //     Route::post('login', [LoginController::class, 'login'])->name('loginAuth.post');
    ...
    //     // Registration Routes
    //     Route::get('register', [RegisterController::class, 'showRegistrationForm'])->name('registerAuth');
    //     Route::post('register', [RegisterController::class, 'register'])->name('registerAuth.post');
